...
Lasso GLM Results
```{r}
LASSO = function(kfold_list, lambda = 0.00075, seed = 556){
...
return(kable(data.frame(error_rates, cross_entropies_losses, true_positive_rates, true_negative_rates), digits = 2))
